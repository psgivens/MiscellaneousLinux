onmessage = function(e) {
    ...
    DBOpenRequest.onsuccess = function(event) {
      ...
      const transaction = db.transaction(["Pomodoros"], "readwrite");
      ...
      const objectStoreRequest = objectStore.add({name: "rob", userId: "bsmith", startTime: new Date("2015-03-25T12:00:00Z") });
      objectStoreRequest.onsuccess = function() {
          console.log("**DB** OSRequest.onsucces")
      };      
      const index = db.transaction("Pomodoros").objectStore("Pomodoros").index("startIdx")
      var boundKeyRange = IDBKeyRange.bound(new Date("2010-03-25T12:00:00Z"), new Date("2018-03-25T12:00:00Z"), false, true);
      ...
      const index2 = db.transaction("Pomodoros").objectStore("Pomodoros").index("userIdIdx")
      var boundKeyRange2 = IDBKeyRange.bound("andy", "zed", false, true);
